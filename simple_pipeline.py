"""
TEST SCRIPT for extract_features.py. RUN THIS LOCALLY TO ENSURE EVERYTHING IS WORKING AS EXPECTED
...
logging.basicConfig(filename='logs/test/feature_extraction_'+electrode+'_'+job_id+'.txt', level=logging.DEBUG)
...
if args.diffs:
    ...
    # remove any occurences of the corner eletrodes (they are labelled 0)        
